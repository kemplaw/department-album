<template>
  <div class="container" id="scroll-hook">
    <div class="wrapper">
...
<script>
  ...
  export default {
    ...
    methods: {
      initBScroll() {
        let wrapper = document.getElementById('scroll-hook');
